    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2 text-white/40 text-xs font-semibold mb-6">
          ...
          <span className="text-orange">{breadcrumb}</span>
        </div>

        <div className="max-w-2xl">
          <span className="inline-flex items-center gap-2 bg-orange/15 border border-orange/35 text-orange text-[11px] font-bold uppercase tracking-[0.15em] px-4 py-1.5 rounded-full mb-5">
          ...
          <h1 className="font-extrabold text-white leading-[1.05] tracking-tight mb-4 text-[32px] sm:text-4xl md:text-5xl">
